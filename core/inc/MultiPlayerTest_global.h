...
#include <chrono>
// Params
// <LIBRARY NAME SHORT>=MPT 
//
#ifndef BUILD_STATIC
	//#pragma message("MULTIPLAYERTEST_LIB is a shared library")
	#if defined(MULTIPLAYERTEST_LIB)
		#define MULTI_PLAYER_TEST_EXPORT __declspec(dllexport)
	#else
		#define MULTI_PLAYER_TEST_EXPORT __declspec(dllimport)
	#endif
#else 
	//#pragma message("MULTIPLAYERTEST_LIB is a static library")
	#define MULTI_PLAYER_TEST_EXPORT
#endif
